...
public class LetterNumberSumTool implements CipherTool {
    ...
    public int getLayoutId() {
        return R.layout.letter_number_sum_tool;
    }

    @Override
    public int getTitleId() {
        return R.string.letterNumberSumToolName;
    }
    ...
    private OnClickListener letterListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            firstText.setText(letter.toString());
            compute();
        }
    };
    ...
    protected void compute() {
        ...
        int letterIndex = alphabet.getIndexByChar(letter);
        int shift = number;

        int result = alphabet.shiftAsIndex(letterIndex, shift, encodeButton.isChecked());
